  ...
  this.MentionsKinder = (function() {
    ...
    MentionsKinder.prototype.triggerDefaultOptions = {
      ...
      formatter: function(data) {
        ...
        if(data.trigger == '#'){
          $mention = $("<span class='mention label "+data.triggerOptions.triggerName+"' contenteditable='false' data-key='tag"+data.id+"'  data-tag='"+data.name+"'></span>");
        }else{
          $mention = $("<span class='mention label "+data.triggerOptions.triggerName+"' contenteditable='false'  data-tag='"+data.name+"'></span>");
        }
      ...
      serializer: function(data) {
       ...
       return `<span class="ckinda-item `+data.triggerOptions.triggerName+`" data-key="`+data.triggerOptions.triggerName+``+data.value+`">`+data.trigger+``+data.name+`</span>`;
