...
$('#total-que').change(function() {
    var basic=$('#total-que').val();

    var subject_id=$('#subject').val();

    var total_question_count = parseInt(basic);
     // var flag = true;
                ...
                response=JSON.parse(response)
                    if(response['status'] == true){
                        if(parseInt(basic) <= parseInt(response['basic_count'])){
                            ...
                            alert("there are only "+response['basic_count'] + "question/questions in the audio question_bank")
                            $('#total-que').val('');
                        }
                    }else{
