			...
			$(document).ready(function ()
			{
				...
				$(".review_Response").on("click", function () 
				{
					var que_id_get = $("input[name='que_id_get']").val();
					
					$("input[name='basic_radio']").attr("checked", false);
				...
				$(".btn_next").on("click", function ()
				{
					...
					if (!quizOver)
					{
                        ...
                        $.ajax({
                            url:"/candidate/image_exam_fill/"+temp_id+"/"+job_id,
...
//                                console.log(response['url'])
			...
			function displayCurrentQuestion()
			{
                ...
                console.log(questions[currentQuestion].q_image)
				$(".Question_listing .question_image").html('<img height="300px" width="300px" src="'+base_url+''+ questions[currentQuestion].q_image+'">')
				...
				for (i = 0; i < numChoices; i++)
				{
                    ...
                    if (questions[currentQuestion].choicesimage[i]==null){
				        ...
				        var ans_image ='<div class="ans_option_image"><img height="150px" width="150px" src="'+base_url+''+questions[currentQuestion].choicesimage[i]+'"></div>';
                    }
