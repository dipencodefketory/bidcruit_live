$(function() {
    ...
    $('#advance-que').change(function() {
        ...
        if(parseInt(advance) > parseInt(total_advance_avl)){
            alert("There are only  "+ total_advance_avl + "questions available in the advance category of image question bank")
            $('#advance-que').val('');
        }else{
    ...
    $('#intermediate-que').change(function() {
        ...
        if(parseInt(intermediate) > parseInt(total_intermediate_avl)){
            alert("There are only  "+ total_intermediate_avl + "questions available in the intermediate category of image question bank")
    ...
    $('#basic-que').change(function() {
        ...
        if(parseInt(basic) > parseInt(total_basic_avl)){
            alert("There are only  "+ total_basic_avl + "questions available in the basic category of image question bank")
            $('#basic-que').val('');
        }else{
            check_queno_type(basic,intermediate,advance);
        }
    ...
    $('#subject').change(function(){
        ...
        $.ajax({
            url:"/company/image_total_questions/" + subject_id + "",
