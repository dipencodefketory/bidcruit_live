$(document).ready(function(){
    ...
    $('#add-sub-form').on('submit',async function(e){
        ...
        var url = "/agency/preview_mcq/" + createSubId['subject_id'];
        var tabClone = `<div class="fx-mini-card card">
            ...
            var tabClone =`<div class="fx-mini-card card">
                        ...
                        <div class="fx-col bind-sm-row pt-3 pb-3">
                            ...
                            <div class="fx-right">
                                <a class="i_color" href="/agency/preview_mcq/`+createSubId['subject_id']+`" target="_blank"><i class="fas fa-eye"></i></a>

                                <a class="i_color" href="/agency/add_mcq/`+createSubId['subject_id']+`" target="_blank"><i class="fas fa-plus"></i></a>`                                                 
