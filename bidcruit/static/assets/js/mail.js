$(function() {
	...
	$(document).on('click', '.mail-menu', function(event) {
			$('.tab-list-items').addClass('mail-menu-show');
			$('.mail-overlay').addClass('mail-overlay-show');
	})
	$(document).on('click', '.mail-overlay', function(event) {
		$('.tab-list-items').removeClass('mail-menu-show');
